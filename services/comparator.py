...
class SpecificationComparator:
    ...
    ВАЖНО: Сравнивай ТОЛЬКО те характеристики, которые присутствуют в ТЗ. НЕ добавляй в результат характеристики, которых нет в ТЗ, даже если они есть в паспорте.
...

    {
      ...
      "details": {
          "criterion_name": {
              ...
              "quote": "цитата, по которой ты принял решение. Размер не более 30 слов"
          }
      }
    }

    Требования:
    - Сравнивай ТОЛЬКО характеристики из ТЗ. НЕ добавляй характеристики из паспорта, которых нет в ТЗ.
    ...
    Когда будешь возвращать цитату, то приведи в кавычках прямую цитату из ТЗ и из Паспорта. Пример - Паспорт: 'От 0 до +90; От -40 до +120' ТЗ: 'не более 90 и не менее 0 градусов'
...

    {
      ...
      "details": {
          "criterion_name": {
              ...
              "actual": "значение из паспорта или null",
              "message": "краткое объяснение",
               "quote": "Прямая цитата из данных, по которой ты принял решение. Размер не более 150 слов"
          }
      }
    }
