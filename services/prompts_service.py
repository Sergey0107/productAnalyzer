...
def get_tz_analyze_prompt():
    return ('Данные, которые ты получил - это данные из docx документа технического задания на покупку изделия. '
            ...
            '- НЕ создавай поля с null, пустыми значениями или значениями типа "не указано", "не указана", "отсутствует" - добавляй только те характеристики, для которых есть конкретное значение в документе\n'
